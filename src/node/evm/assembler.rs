use crate::{
    ...
    consensus::parlia::{EMPTY_REQUESTS_HASH, EMPTY_WITHDRAWALS_HASH, Parlia}, 
    hardforks::BscHardforks, 
    node::{
        evm::config::{BscBlockExecutionCtx, BscBlockExecutorFactory, BscExecutionCustomCtx},
    ...
    ChainSpec: EthChainSpec + EthereumHardforks + crate::hardforks::BscHardforks + 'static,
{
    ...
    fn assemble_block(
        ...
        todo!("bsc block assembler assemble_block is unused, BscBlockBuiler use assemble_block_bsc instead.")
    }
}
